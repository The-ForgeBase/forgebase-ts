...
export function createVerifyRouter(authManager: DynamicAuthManager, config: ExpressAuthConfig): Router {
  const router = Router();
  ...
  router.post('/verify-token', authGuard, async (req: any, res: Response) => {
    try {
