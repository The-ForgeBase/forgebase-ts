...
@Component({
  ...
  template: `
    <hlm-menu-bar class="w-fill border-0">
      <button hlmMenuBarItem [brnMenuTriggerFor]="music" class="px-3 font-bold">
        ForgeBase Studio
      </button>
      <button
        hlmMenuBarItem
        [brnMenuTriggerFor]="file"
      ...
      <hlm-menu variant="menubar" class="w-48">
        <hlm-menu-group>
          ...
          <button hlmMenuItem>
            Smart Dictation...
            <hlm-menu-shortcut
              ><ng-icon hlm size="sm" name="lucideMicVocal"
            /></hlm-menu-shortcut>
          </button>
          <button hlmMenuItem>
            Emoji & Symbols
    ...
    <ng-template #account>
      <hlm-menu variant="menubar" class="w-48">
        <hlm-menu-group>
          <button inset hlmMenuItem class="font-semibold">
            Switch Account
          </button>
